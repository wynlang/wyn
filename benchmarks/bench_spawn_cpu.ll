...
while.header3:                                    ; preds = %while.body4, %while.end
  ...
  %icmp7 = icmp slt i32 %wait6, 500000000
  br i1 %icmp7, label %while.body4, label %while.end5

while.body4:                                      ; preds = %while.header3
  %wait8 = load i32, ptr %wait, align 4
  %add9 = add i32 %wait8, 1
  store i32 %add9, ptr %wait, align 4
  br label %while.header3

while.end5:                                       ; preds = %while.header3
  %time_now10 = call i64 @wyn_time_now()
  %start11 = load i64, ptr %start, align 4
  %sub = sub i64 %time_now10, %start11
  store i64 %sub, ptr %elapsed, align 4
  %elapsed12 = load i64, ptr %elapsed, align 4
  %0 = call i32 (ptr, ...) @printf(ptr @fmt, i64 %elapsed12)
  ret i32 0
}

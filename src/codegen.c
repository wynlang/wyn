...
int is_c_name_collision(const char* name) {
    ...
    static const char* reserved[] = {
        ...
        "array_sum_float","array_min_float","array_max_float",
        "array_first_float","array_last_float","array_pop_float",
        "array_contains_float","array_index_of_float",
        ...
        "hashmap_get_or_int","hashmap_get_or_str","hashmap_get_or_float","hashmap_get_or_bool",
        "wyn_map_compound_missing_key",

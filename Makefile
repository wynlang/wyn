...
test: wyn test_unit test_stdlib test_errors test_control_flow test_phase2_integration test_arc_operations test_weak_references test_cycle_detection test_memory_pool test_performance_monitor test_escape_analysis test_arc_insertion test_weak_codegen test_arc_optimization

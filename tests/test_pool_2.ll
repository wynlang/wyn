...
@str = private unnamed_addr constant [99 x i8] c"timeout 2 /Users/aoaws/src/ao/wyn-lang/wyn/tests/unit/test_collection_methods.out > /dev/null 2>&1\00", align 1
@str.1 = private unnamed_addr constant [94 x i8] c"timeout 2 /Users/aoaws/src/ao/wyn-lang/wyn/tests/unit/test_array_various.out > /dev/null 2>&1\00", align 1

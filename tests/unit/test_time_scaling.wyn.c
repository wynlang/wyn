...
int wyn_main() {
    int y1 = is_leap_year(2000);
    ;
    int y2 = is_leap_year(2004);
    ;
    int y3 = is_leap_year(2008);
    ;
    int y4 = is_leap_year(2012);
    ;
    int y5 = is_leap_year(2016);
    ;
    int y6 = is_leap_year(2020);
    ;
    int y7 = is_leap_year(2024);
    ;
    int y8 = is_leap_year(2001);
    ;
    int y9 = is_leap_year(2002);
    ;
    int y10 = is_leap_year(2003);
    ;
    int m1 = days_in_month(1);
    ;
    int m2 = days_in_month(2);
    ;
    int m3 = days_in_month(3);
    ;
    int m4 = days_in_month(4);
    ;
    int m5 = days_in_month(5);
    ;
    int m6 = days_in_month(6);
    ;
    int m7 = days_in_month(7);
    ;
    int m8 = days_in_month(8);
    ;
    int m9 = days_in_month(9);
    ;
    int m10 = days_in_month(10);
    ;
    int m11 = days_in_month(11);
    ;
    int m12 = days_in_month(12);
    ;

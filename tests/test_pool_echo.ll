...
@str = private unnamed_addr constant [7 x i8] c"echo 1\00", align 1
@str.1 = private unnamed_addr constant [7 x i8] c"echo 2\00", align 1
@str.2 = private unnamed_addr constant [7 x i8] c"echo 3\00", align 1

...
define i32 @wyn_main() {
entry:
  %simple_async = call i32 @simple_async()
  %compute = call i32 @compute(i32 10)
  %0 = call ptr @wyn_spawn_async(ptr @__spawn_compute_0, ptr null)
  %regular = call i32 @regular()
  %1 = call i32 (ptr, ...) @printf(ptr @fmt, i32 1)
  ret i32 0
}

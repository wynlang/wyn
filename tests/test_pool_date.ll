...
@str = private unnamed_addr constant [38 x i8] c"date +%s.%N && sleep 1 && date +%s.%N\00", align 1
@str.1 = private unnamed_addr constant [38 x i8] c"date +%s.%N && sleep 1 && date +%s.%N\00", align 1

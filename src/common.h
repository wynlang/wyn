...
typedef enum {
    TOKEN_EOF,
    TOKEN_ERROR,  // lexer-level error (e.g. unterminated string); message in lexer_error_msg
    TOKEN_INT, TOKEN_FLOAT, TOKEN_STRING, TOKEN_CHAR, TOKEN_IDENT,
    TOKEN_FN, TOKEN_STRUCT, TOKEN_ENUM, TOKEN_TYPEDEF, TOKEN_IMPL, TOKEN_TRAIT, TOKEN_MAP, TOKEN_EXTERN, TOKEN_UNSAFE, TOKEN_MACRO,
    ...
    TOKEN_BREAK, TOKEN_CONTINUE, TOKEN_RETURN, TOKEN_DEFER,
    ...
    TOKEN_COMMA, TOKEN_COLON, TOKEN_COLONCOLON, TOKEN_SEMI, TOKEN_DOT, TOKEN_DOTDOT, TOKEN_DOTDOTEQ, TOKEN_DOTDOTDOT, TOKEN_ARROW, TOKEN_FATARROW, TOKEN_QUESTION, TOKEN_QUESTION_QUESTION, TOKEN_PIPEGT, TOKEN_PIPE_CLOSURE, TOKEN_QUESTION_DOT, TOKEN_UNDERSCORE, TOKEN_YIELD,
} WynTokenType;

...
void Rectangle_cleanup(Rectangle* obj) {
}
...
void Circle_cleanup(Circle* obj) {
}

int sum(int p);
int multiply(int p);
int distance_squared(int p);
int area(int r);
int perimeter(int r);
int area(int c);
int wyn_main();
...
int wyn_main() {
    ...
    ;
    const Rectangle r = (Rectangle){.width = 5, .height = 6};
    ;
    const Circle c = (Circle){.radius = 2};
    ;
    const int sum = Point_sum(p);
    ;
    const int mult = Point_multiply(p);
    ;
    const int dist = Point_distance_squared(p);
    ;
    const int rect_area = Rectangle_area(r);
    ;
    const int perim = Rectangle_perimeter(r);
    ;
    const int circ_area = Circle_area(c);
    ;
